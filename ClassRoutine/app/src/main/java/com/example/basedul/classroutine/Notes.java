...
public class Notes extends Fragment {
    NoteInformation no;
    public static final String TAG = "Bodru1";
    List<NoteInformation> arrayList;
    public Notes() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<NoteInformation> arrayList = new ArrayList<>();;
        Adapter adapter;
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // arrayList = HelperToFragment.myDatabase.myDao().getUsers();
            }
        });
